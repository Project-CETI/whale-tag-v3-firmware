...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  */
    ...
    PB6     ------> USART1_TX
    */
    GPIO_InitStruct.Pin = GPS_USART1_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF7_USART1;
    HAL_GPIO_Init(GPS_USART1_RX_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = GPS_USART1_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF7_USART1;
    HAL_GPIO_Init(GPS_USART1_TX_GPIO_Port, &GPIO_InitStruct);
  ...
  */
    ...
    PA3     ------> USART2_RX
    */
    GPIO_InitStruct.Pin = SATELLITE_USART2_TX_Pin|SATELLITE_USART2_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PB6     ------> USART1_TX
    */
    HAL_GPIO_DeInit(GPS_USART1_RX_GPIO_Port, GPS_USART1_RX_Pin);

    HAL_GPIO_DeInit(GPS_USART1_TX_GPIO_Port, GPS_USART1_TX_Pin);
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    PA3     ------> USART2_RX
    */
    HAL_GPIO_DeInit(GPIOA, SATELLITE_USART2_TX_Pin|SATELLITE_USART2_RX_Pin);
