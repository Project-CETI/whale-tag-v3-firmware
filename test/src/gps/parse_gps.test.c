...
void test_parse_valid_rmc_northern_eastern(void) {
    ...
    const uint8_t *sentence = (const uint8_t *)"$GNRMC,134523.00,A,4807.0380,N,01131.0000,E,0.0,0.0,230525,,,A*6E";
...
void test_parse_valid_rmc_southern_western(void) {
    const uint8_t *sentence = (const uint8_t *)"$GPRMC,092750.00,A,5321.6802,S,00630.3372,W,0.02,31.66,280511,,,A*43";
...
void test_parse_truncated_before_date_returns_invalid(void) {
    ...
    const uint8_t *sentence = (const uint8_t *)"$GNRMC,134523.00,A,4807.0380,N,01131.0000,E";
...
void test_parse_midnight_time(void) {
    const uint8_t *sentence = (const uint8_t *)"$GNRMC,000000.00,A,4807.0380,N,01131.0000,E,0.0,0.0,010125,,,A*00";
...
void test_parse_no_subminutes_in_coords(void) {
    ...
    const uint8_t *sentence = (const uint8_t *)"$GNRMC,120000.00,A,4807,N,01131,E,0.0,0.0,150625,,,A*00";
