...
#define IMPLEMENT_QUATERION_TYPE(T)                                                                                       \
    __attribute__((const)) static inline Quaternion(T) quaternion_multiplication(T)(Quaternion(T) q1, Quaternion(T) q2) { \
        return (Quaternion(T)){                                                                                           \
            ...
            .k = q1.real * q2.k + q1.i * q2.j - q1.j * q2.i + q1.k * q2.real,                                             \
                                                                                                                          ...
                                                                                                                          \
    __attribute__((const)) static inline Quaternion(T) quaternion_remove_yaw(T)(Quaternion(T) q_in) {                     \
        ...
        return quaternion_multiplication(T)(q_deyaw, q_in);                                                               \
                                                                                                                          ...
                                                                                                                          \
    __attribute__((const)) static inline Quaternion(T) quaternion_addition(T)(Quaternion(T) q1, Quaternion(T) q2) {       \
        return (Quaternion(T)){                                                                                           \
            ...
            .k = q1.k + q2.k,                                                                                             \
                                                                                                                          ...
                                                                                                                          \
    __attribute__((const)) static inline Quaternion(T) quaternion_subtraction(T)(Quaternion(T) q1, Quaternion(T) q2) {    \
        return (Quaternion(T)){                                                                                           \
            .real = q1.real - q2.real,                                                                                    \
            .i = q1.i - q2.i,                                                                                             \
            .j = q1.j - q2.j,                                                                                             \
            .k = q1.k - q2.k,                                                                                             \
                                                                                                                          ...
                                                                                                                          \
    __attribute__((const)) static inline T quaternion_magnitude(T)(Quaternion(T) q) {                                     \
