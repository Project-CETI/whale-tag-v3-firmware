...
void ads1219_stop(void) {
    __ads1219_write_cmd(ADS1219_CMD_POWERDOWN);
}
...
static void __ads1219_read_data_raw_write_callback(I2C_HandleTypeDef *hi2c) {
    HAL_I2C_RegisterCallback(&ECG_hi2c, HAL_I2C_MASTER_RX_COMPLETE_CB_ID, __ads1219_read_data_raw_read_callback);
...
void ads1219_read_data_raw_it(int32_t *reading, void (*callback)(void)) {
    ...
    __ads1219_write_cmd_it(&s_rreg_cmd, __ads1219_read_data_raw_write_callback);
}
