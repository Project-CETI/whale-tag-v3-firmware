...
size_t m10s_ubx_cfg_set_msg_rate(uint8_t *buffer, size_t buffer_length, uint8_t data_rate_s) {
    uint8_t payload[] = {
        ...
        0x91,
        0x20,
        (uint8_t)(data_rate_s & 0xff), // NMEA_ID_GGA_UART1
        0xca,
        0x00,
        0x91,
        0x20,
        (uint8_t)(data_rate_s & 0xff), // NMEA_ID_GLL_UART1
        0xc0,
        0x00,
        0x91,
        0x20,
        (uint8_t)(data_rate_s & 0xff), // NMEA_ID_GSA_UART1
        0xc5,
        0x00,
        0x91,
        0x20,
        (uint8_t)(data_rate_s & 0xff), // NMEA_ID_GSV_UART1
        0xac,
        0x00,
        0x91,
        0x20,
        (uint8_t)(data_rate_s & 0xff), // NMEA_ID_RMC_UART1
        0xb1,
        0x00,
        0x91,
        0x20,
        (uint8_t)(data_rate_s & 0xff), // NMEA_ID_VTG_UART1
...
size_t m10s_enter_software_standby_mode(uint8_t buffer[static 24], size_t buffer_length) {
    uint8_t payload[] = {
        ...
        0x00,
        0x00,
        0x00, // duration ms //wait for signal
        PMREQ_FLAGS_BACKUP | PMREQ_FLAGS_FORCE,
        0x00,
        0x00,
        0x00, // flags | u1:b1 (backup), u1:b2 (force)
        PMREQ_WAKEUPSOURCE_UART_RX | PMREQ_WAKEUPSOURCE_EXT_INT_0 | PMREQ_WAKEUPSOURCE_EXT_INT_1,
        0x00,
        0x00,
        0x00, // wakeupSources | u1:b3 (uart_rx) | u1:b5 (ext_int_0) | u1:b6 (ext_int_1) | u1:b7 (spi_cs)
    };
